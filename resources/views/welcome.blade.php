...
<div class="header header-filter" style="background-image: url('https://images.unsplash.com/photo-1423655156442-ccc11daa4e99?crop=entropy&dpr=2&fit=crop&fm=jpg&h=750&ixjsv=2.1.0&ixlib=rb-0.3.5&q=50&w=1450');">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h1 class="title">Bienvenido a App Shop Cudesi</h1>
        ...
        <div class="section text-center section-landing">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <h2 class="title">¿Por qué Cudesi Service?</h2>
                    <h5 class="description">Puedes revisar la relación completa de nuestros productos/servicios, compara precios con otros proveedores y luego realizar tu pedido cuando estés seguro, te esperamos, estaremos atentos a tus consultas.</h5>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="info">
                            ...
                            <p>Los pedidos que raelices sólo los conocerás tú, a través de tu panel de usuario. Nadie más tiene acceso a esta información.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="team-player">
                            <img src="{{ $product->featured_image_url }}" alt="Foto de Producto" class="img-raised img-circle">
